...
linkedin = oauth.remote_app('linkedin',
    ...
    consumer_key=os.environ['LINKEDIN_CONSUMER_KEY'],
    consumer_secret=os.environ['LINKEDIN_CONSUMER_SECRET']
)
...
facebook = oauth.remote_app('facebook',
    ...
    consumer_key=os.environ['FACEBOOK_ID'],
...
def facebook_login():
    return redirect("https://www.facebook.com/dialog/oauth?%s" %
                    urllib.urlencode({'client_id': os.environ['FACEBOOK_ID'],
